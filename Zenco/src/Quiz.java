...
public class Quiz {
    ...
    public void setDefaultQuiz(){
        ...
        questions.add(new Question(2,'D',"I feel as if I am slowed down: ",responseD4));
        ...
        questions.add(new Question(3,'D',"I still enjoy the things I used to enjoy: ",responseD1));
        ...
        questions.add(new Question(4,'A',"I get a sort of frightened feeling like \n" +
        ...
        questions.add(new Question(5,'A',"I get a sort of frightened feeling as if " +
        ...
        questions.add(new Question(6,'D',"I have lost interest in my appearance:\n ",responseD5));
        ...
        questions.add(new Question(7,'A',"I feel restless as I have to be on the \n" +
                "move:\n",responseA6));
        ...
        questions.add(new Question(8,'D',"I can laugh and see the funny side of things:\n",responseD2));
        ...
        questions.add(new Question(9,'A',"Worrying thoughts go through my mind : ",responseA3));
        ...
        questions.add(new Question(10,'D',"I look forward with enjoyment to things:\n",responseD6));
        ...
        questions.add(new Question(11,'A',"I get sudden feelings of panic:",responseA7));
        ...
        questions.add(new Question(12,'D',"I feel cheerful:  ",responseD3));
        ...
        questions.add(new Question(13,'A',"I can sit at ease and feel relaxed: ",responseA4));
